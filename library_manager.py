...
def load_library():
    try:
        ...
        st.error(f"Library load karne mein error: {e}")
        return False
...
def save_library():
    try:
        ...
        st.error(f"Library save karne mein error: {e}")
        return False
...
def create_visualizations(stats):
    ...
    if stats['genres']:
        pass  # Implementation for genre visualization goes here
...
# Book publication decade visualization
    if stats['decades']:
...
lottie_book = load_lottieurl("https://assets9.lottiefiles.com/temp/1f20akAfIn.json")
if lottie_book:
    with st.sidebar:
            ...
            with st.spinner("Searching..."):
                ...
                if hasattr(st.session_state, 'search_results'):
                    if st.session_state.search_results:
                        st.markdown("<h3> Found {len(st.session_state.search_result)} results:</h3>", unsafe_allow_html=True)
                          ...
                          st.markdown("<div class='warning-message'> Your library is empty. Add some books to get started!</div>", unsafe_allow_html=True)
                            ...
                            if stats['authors']:
                                ...
                                for author, count in top_authors.items():
                                    ...
                                    st.markdown("-------------------------------------")
                                    st.markdown("copyright @ 2025 Madiha Khan Personal Library Manager", unsafe_allow_html=True)
